...
git clone --depth=1 https://github.com/xiaorouji/openwrt-passwall-packages passwall-packages && mv -n passwall-packages/* ./relevance/passwall-packages/ ; rm -rf passwall-packages
